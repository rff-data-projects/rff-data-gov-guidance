...
Without documentation, projects lose their usefulness over time, as illustrated below.

![Image from [https://edirepository.org/resources/creating-metadata-for-publication](https://edirepository.org/resources/creating-metadata-for-publication)](../../images/tidy-data.png)
<img class="figure-img" src="/static/images/information_loss.png" width="65%">
