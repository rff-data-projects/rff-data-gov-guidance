...
### Start here: Data management planning for reproducibility {#sec-dmp}
...
This guidance resource provides general instructions for good data management practices and addresses many of the core questions that are part of the DMP process. *__At a minimum, the following questions should be reviewed at the start of a project__*:

1.	Where will data/code be stored and how will it be organized?
...
3.	Who will be responsible for disposing / archiving data?

4.	Who will be responsible for publishing data/code and attaching appropriate documentation and use licenses?
...
9.	How will data sources, code, and major methodological decisions be documented?
