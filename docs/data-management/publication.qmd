...
For software and data, there are three common license suites common in the academic space: *MIT*, *GNU GPU*, and *ODC*. *MIT* and *GNU GPU* are separate software licenses, while *ODC* has two commonly-used data licenses. All four are described below.
...
This license is well suited for libraries and tools where broad reuse is encouraged, including in proprietary or closed-source contexts.
...
This license is well suited for models, scripts, and workflows where preserving long-term openness and share-alike reuse is a priority.
