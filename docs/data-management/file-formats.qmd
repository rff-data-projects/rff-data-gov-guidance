...
For RFF communications, however, the Scalable Vector Graphics format `.svg` is best because it can be easily modified as needed. Academic journals often accept this format as well.
