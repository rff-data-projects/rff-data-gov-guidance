...
For RFF communications, however, vector formats such as **.svg** and **.pdf** are best because they can be easily modified by the RFF Comms team. Academic journals often accept these formats as well. You may want to consider saving plots in multiple file formats.
