...
__The source of all downloaded raw datasets should be documented in a README file.__
...
* Name the README so that it is easily associated with the data file(s) it describes (e.g., `README_PRISM_Daily_Temperature.txt`).
