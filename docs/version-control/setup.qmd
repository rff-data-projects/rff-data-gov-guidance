...
Say there is an existing repository on GitHub that you would like to download in order to modify or explore on your computer.
The process for creating a local copy on your computer is called [cloning](./terminology.qmd#clone).

1. Open Git Bash or CMD. Navigate to the folder you would like to clone the repository into.  For example `cd 'C:\Users\<my-user-name>\OneDrive - rff\repos'`.
2. In a browser, navigate to the repository's GitHub page.  For example, [https://github.com/e4st-dev/E4ST.jl](https://github.com/e4st-dev/E4ST.jl).
