...
Essentially, the workflow begins with either [create a new repository](#creating-a-repository) or [clone an existing repository](#cloning-a-repository).  A repository is simply a folder that is version-controlled by Git, and usually hosted by GitHub.  
...
The process for downloading an existing GitHub repository is called "cloning".
In order to clone an existing project repository, navigate to that repository <TODO: Finish this>
