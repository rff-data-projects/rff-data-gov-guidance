...
* __Consolidates__  and __Organizes__ project code and documentation in the same, easily-accessible, backed-up location.
...
Not only does GitHub host these repositories, but it also provides convenient ways to host documentation, discuss code changes, and report bugs.
