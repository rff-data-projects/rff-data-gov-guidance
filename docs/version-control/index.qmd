...
While it is possible to use Git only on your computer without posting it online, it is often advisable to host repositories online so that they are synced in the cloud, making it easy to share and back-up.
While there are many websites that can host Git repositories, the most popular is called **GitHub**, which is what we recommend using at RFF. (Some others you may come across GitLab and BitBucket)
...
GitHub has individual user accounts, but also groups of users called **organizations**.