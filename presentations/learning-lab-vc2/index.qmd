...
Imagine: You're working on a new analysis when you discover a bug in your model. How do you fix the bug without losing your in-progress work?
...
::: {.fragment}
Branches let you work on multiple versions of your code simultaneously - fix the bug on one branch while keeping your new analysis safely on another.
:::
...
Create and check out a new branch in one step:
...
::: {.fragment}
![Git Feature Branch](../../images/git-feat-branch.png){width=900}
:::
...
* 2. Look for: logic errors, code clarity, edge cases, style consistency
* 3. Add comments by clicking the `+` next to line numbers
* 4. Be specific and constructive: "Consider adding a check for empty data here"
* 5. Complete your review: approve, request changes, or just comment
:::
