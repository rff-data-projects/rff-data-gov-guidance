...
## What is Branching? {auto-animate="true"}
...
## The Branching Workflow {auto-animate="true"}
...
4. When ready to merge, create a __Pull Request__ in GitHub
...
A __Pull Request__ (or "PR") is a GitHub feature that lets you propose merging your branch into another branch (usually `main`).
